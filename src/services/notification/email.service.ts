...
<head>
  ...
  <style>
    ...
    .wrapper { width: 100%; padding: 40px 20px; background-color: #f4f4f7; }
    ...
    .code-box { background: #f3f4f6; border: 2px dashed #6366f1; border-radius: 12px; padding: 24px; text-align: center; margin-bottom: 32px; }
    .code { font-size: 48px; font-weight: 800; letter-spacing: 16px; color: #6366f1; font-family: 'Courier New', monospace; }
  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="body">
        ...
        <p class="description">
          Recibimos una solicitud para verificar tu identidad. Usa el siguiente código para continuar. 
          No lo compartas con nadie.
        </p>
        <div class="code-box">
          <div class="code">${code}</div>
          <p class="expiry">⏱ Válido por <strong>5 minutos</strong></p>
        </div>
        <div class="warning">
      ...
      <div class="footer">
        <p>Este correo fue enviado automáticamente. Por favor no respondas.<br/>© ${new Date().getFullYear()} Tu App. Todos los derechos reservados.</p>
      </div>
    </div>
  </div>
</body>
